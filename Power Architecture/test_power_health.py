...
class TestIntegration:
    ...
    def test_full_pipeline_failing_battery(self):
        ...
        packets = [
            ...
            sys_status_msg(voltage_mv=21400, current_ca=300,
                           battery_pct=15,
                           **{"battery_resistance": 45}),  # 45mΩ = 3× baseline
        ]
        # Patch sys_status to include resistance
    ...
    def test_redis_publish_called(self):
        from consumer_updated import ConsumerWorker
        ...
        worker = ConsumerWorker("DR-001", r)
        worker._process({b"data": json.dumps({
            "type": "BATTERY_STATUS",
            "ts": time.time(),
            "data": {
                "voltages": [4100]*6 + [65535]*4,
